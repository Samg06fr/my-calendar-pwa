const CACHE_NAME = "my-calendar-shell-v1";
...
// Network-first for navigation/API, cache-first fallback for shell assets, offline fallback to cached index.html
...
self.addEventListener("push", (event) => {
  ...
  const title = data.title || "Calendar reminder";
  const options = {
    body: data.body || "",
